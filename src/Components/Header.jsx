...
const Header = ({ searchEngine, setSearchEngine }) => {
    ...
    return (
        <header>
            ...
            <input type="text" className='searchBar' value={searchEngine} onChange={(e) => setSearchEngine(e.target.value)} id='search' placeholder='   ¿Que estas buscando?'></input>

            <button className='searchButton' id='searchBtn' onClick={() => { clickSearch() }}> <img src={Lupa} className='imgSearchButton' alt='boton buscar' /> </button>
